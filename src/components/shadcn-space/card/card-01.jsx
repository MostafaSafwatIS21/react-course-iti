          ...
          <CardContent className='p-6 pt-5'>
            ...
            <motion.div
              ...
              <motion.div
                ...
                className='-ms-2'>
                <div
                  className='bg-primary-foreground outline-2 outline-background h-10 w-10 flex justify-center items-center text-foreground rounded-full text-base font-medium'>
                  +4
                </div>
              </motion.div>
            </motion.div>
